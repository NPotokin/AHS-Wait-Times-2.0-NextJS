    ...
    <div className=' rounded-3xl grid grid-cols-3 gap-1'>
      ...
      <div 
        ...
        <ResponsiveContainer width={'100%'} height={250}>
          <AreaChart aria-label='Hourly Area chart' data={filteredDataHr} margin={{ top: 20, right: 40, left: 0, bottom: 0 }}>
            <XAxis dataKey='dateTime' stroke="#0891b2" aria-label='time' />
            <YAxis stroke="#0891b2" aria-label='wait time'/>
            <Tooltip bac/>
            <Area type="monotone" dataKey="waitTimeMin" stroke="#0891b2" fill="#0891b2" aria-label='wait time' />
          </AreaChart>
        </ResponsiveContainer>
      </div>

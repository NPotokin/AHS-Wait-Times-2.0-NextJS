    ...
    <div className=' rounded-3xl grid grid-cols-3 gap-1'>
      ...
      <div 
        ...
        <ResponsiveContainer width={'100%'} height={250}>
          <BarChart aria-label='bar chart for 12 hours' data={filteredData12Hr} margin={{ top: 20, right: 40, left: 0, bottom: 0 }}>
            <XAxis dataKey='dateTime' aria-label='time' stroke="#0891b2" tickCount={1} />
            <YAxis stroke="#0891b2" aria-label='wait time'/>
            <Tooltip bac/>
            <Bar  dataKey="waitTimeMin"  fill='#0891b2' aria-label='wait time' />
          </BarChart>
        </ResponsiveContainer>
      </div>

...
const HospitalGraphMonth = (props) => {
    ...
    <div className=' rounded-3xl grid grid-cols-3 gap-1'>
      ...
      <div 
        ...
        <ResponsiveContainer width={'100%'} height={250}>
          <BarChart data={filteredDataMonth} margin={{ top: 20, right: 40, left: 0, bottom: 0 }}>
            <XAxis dataKey='dateTime' stroke="#0891b2"  />
            <YAxis stroke="#0891b2"/>
            <Tooltip bac/>
            <Bar  dataKey="waitTimeMin" stroke="#0891b2" fill="#0891b2" />
          </BarChart>
        </ResponsiveContainer>
      </div>
...
export default HospitalGraphMonth

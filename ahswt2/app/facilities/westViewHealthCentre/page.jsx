...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'westviewHealthCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'westviewHealthCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'westviewHealthCentre');

...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'srathconaCommunityHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'srathconaCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'srathconaCommunityHospital');

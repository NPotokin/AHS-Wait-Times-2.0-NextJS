...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'strathconaCommunityHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'strathconaCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'strathconaCommunityHospital');

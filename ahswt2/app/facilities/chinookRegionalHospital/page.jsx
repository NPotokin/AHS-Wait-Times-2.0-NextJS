...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'chinookRegionalHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'chinookRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'chinookRegionalHospital');

...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'misericordiaCommunityHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'misericordiaCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'misericordiaCommunityHospital');

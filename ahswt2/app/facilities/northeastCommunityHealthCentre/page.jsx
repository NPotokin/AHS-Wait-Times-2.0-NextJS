...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'northeastCommunityHealthCentre');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'northeastCommunityHealthCentre');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'northeastCommunityHealthCentre');

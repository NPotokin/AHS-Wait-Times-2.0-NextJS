...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'northeastCommunityHealthCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'northeastCommunityHealthCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'northeastCommunityHealthCentre');

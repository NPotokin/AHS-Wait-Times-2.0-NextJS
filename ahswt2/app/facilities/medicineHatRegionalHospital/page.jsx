...
const medicineHatRegionalHospital = () => {
  ...
  return (
    <div className='flex flex-col pb-20'>
        ...
        <div className='grid mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-3'>
          <HospitalGraphHour slug={'medicineHatRegionalHospital'} />
          <HospitalGraphDay slug={'medicineHatRegionalHospital'}/>
          <HospitalGraphWeek slug={'medicineHatRegionalHospital'}/>
        </div>
    </div>
  )
}

export default medicineHatRegionalHospital;
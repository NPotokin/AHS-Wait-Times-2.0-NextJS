...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'medicineHatRegionalHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'medicineHatRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'medicineHatRegionalHospital');

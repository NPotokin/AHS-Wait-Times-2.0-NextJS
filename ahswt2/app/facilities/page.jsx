    ...
    <div className='grid mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
      ...
      <div 
        ...
        <div className="absolute  top-[50%] left-[50%] translate-x-[-50%] 
            ...
            <Link 
            href={item.route}
            className='text-center bg-transparent p-2 md:p-3 rounded-xl text-md md:text-lg lg:text-xl font-semibold  text-cyan-800 border-cyan-800 border-2 hover:bg-cyan-200 duration-1000'>Go to Facility Page</Link>
        </div>
      </div>
      ))}
    </div>

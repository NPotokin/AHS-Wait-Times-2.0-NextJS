...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'innisfailHealthCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'innisfailHealthCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'innisfailHealthCentre');

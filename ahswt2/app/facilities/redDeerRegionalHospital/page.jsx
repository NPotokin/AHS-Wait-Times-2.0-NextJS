...
export default async function redDeerRegionalHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'redDeerRegionalHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'redDeerRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'redDeerRegionalHospital');

...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'redDeerRegionalHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'redDeerRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'redDeerRegionalHospital');

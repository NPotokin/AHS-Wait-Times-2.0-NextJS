...
export default async function cochraneCommunityHealthCentre() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'cochraneCommunityHealthCentre');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'cochraneCommunityHealthCentre');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'cochraneCommunityHealthCentre');

...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'greyNunsCommunityHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'greyNunsCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'greyNunsCommunityHospital');

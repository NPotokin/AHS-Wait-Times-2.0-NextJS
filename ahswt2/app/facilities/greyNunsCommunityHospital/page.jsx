...
export default async function greyNunsCommunityHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'greyNunsCommunityHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'greyNunsCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'greyNunsCommunityHospital');

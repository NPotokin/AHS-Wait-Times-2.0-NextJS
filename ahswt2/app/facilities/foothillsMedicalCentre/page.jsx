...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'foothillsMedicalCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'foothillsMedicalCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'foothillsMedicalCentre');

...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'foothillsMedicalCentre');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'foothillsMedicalCentre');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'foothillsMedicalCentre');

...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'devonGeneralHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'devonGeneralHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'devonGeneralHospital');

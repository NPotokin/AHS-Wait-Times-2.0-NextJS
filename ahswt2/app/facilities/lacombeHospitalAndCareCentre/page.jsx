...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'lacombeHospitalAndCareCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'lacombeHospitalAndCareCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'lacombeHospitalAndCareCentre');

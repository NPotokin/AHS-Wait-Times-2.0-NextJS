...
export default async function sheldonMChumirCentre() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'sheldonMChumirCentre');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'sheldonMChumirCentre');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'sheldonMChumirCentre');

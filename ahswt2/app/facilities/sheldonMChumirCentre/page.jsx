...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'sheldonMChumirCentre');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'sheldonMChumirCentre');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'sheldonMChumirCentre');

...
export default async function albertaChildrensHospital() {
  ...
  const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'albertaChildrensHospital');
  ...
  const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'albertaChildrensHospital');
  ...
  const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'albertaChildrensHospital');

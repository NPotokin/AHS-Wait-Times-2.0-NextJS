...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'southHealthCampus');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'southHealthCampus');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'southHealthCampus');

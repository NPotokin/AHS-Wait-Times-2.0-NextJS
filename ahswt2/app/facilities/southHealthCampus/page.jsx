...
export default async function southHealthCampus() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'southHealthCampus');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'southHealthCampus');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'southHealthCampus');

...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'universityOfAlbertaHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'universityOfAlbertaHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'universityOfAlbertaHospital');

...
export default async function grandePrairieRegionalHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'grandePrairieRegionalHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'grandePrairieRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'grandePrairieRegionalHospital');

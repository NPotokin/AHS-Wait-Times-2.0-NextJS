...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'grandePrairieRegionalHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'grandePrairieRegionalHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'grandePrairieRegionalHospital');

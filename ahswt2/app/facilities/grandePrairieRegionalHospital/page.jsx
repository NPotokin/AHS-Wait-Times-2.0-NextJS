...
const grandePrairieRegionalHospital = () => {
  ...
  return (
    <div className='flex flex-col pb-20'>
        ...
        <div className='grid mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-3'>
          ...
          <HospitalGraphHour slug={'grandePrairieRegionalHospital'} />
          <HospitalGraphDay slug={'grandePrairieRegionalHospital'}/>
          <HospitalGraphWeek slug={'grandePrairieRegionalHospital'}/>
        </div>
    </div>
  )
}

export default grandePrairieRegionalHospital;
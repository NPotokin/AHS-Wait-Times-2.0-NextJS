...
export default async function leducCommunityHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'leducCommunityHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'leducCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'leducCommunityHospital');

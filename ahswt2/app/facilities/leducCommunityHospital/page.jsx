...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'leducCommunityHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'leducCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'leducCommunityHospital');

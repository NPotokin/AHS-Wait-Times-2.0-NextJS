...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'okotoksHealthAndWellnessCentre');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'okotoksHealthAndWellnessCentre');

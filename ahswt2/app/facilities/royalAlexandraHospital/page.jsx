...
export default async function royalAlexandraHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'royalAlexandraHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'royalAlexandraHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'royalAlexandraHospital');

...
export default async function stolleryChildrensHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'stolleryChildrensHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'stolleryChildrensHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'stolleryChildrensHospital');

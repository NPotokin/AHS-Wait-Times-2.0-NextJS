...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'stolleryChildrensHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'stolleryChildrensHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'stolleryChildrensHospital');

...
export default async function sturgeonCommunityHospital() {
...
const filteredDataHr = fetchedDataHr.updatedData.filter((item) => item.slug === 'sturgeonCommunityHospital');
...
const filteredDataDay = fetchedDataDay.averageWaitTimes.filter((item) => item.slug === 'sturgeonCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.averageWaitTimes.filter((item) => item.slug === 'sturgeonCommunityHospital');

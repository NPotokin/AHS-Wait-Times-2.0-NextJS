...
const filteredDataHr = fetchedDataHr.response.filter((item) => item.slug === 'sturgeonCommunityHospital');
...
const filteredDataDay = fetchedDataDay.response.filter((item) => item.slug === 'sturgeonCommunityHospital');
...
const filteredDataWeek = fetchedDataWeek.response.filter((item) => item.slug === 'sturgeonCommunityHospital');

...
const grandePrairieHospitals = Hospitals.filter((hospital) => hospital.municipality === 'Grande Prairie')
...
const grandePrairie = () => {
  return (
    ...
    <div className='grid mx-3 grid-cols-1  gap-3'>
      ...
      {grandePrairieHospitals.map((item) => (
      <div 
        key={item.key}

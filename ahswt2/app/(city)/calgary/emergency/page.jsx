    ...
    <div className='grid mx-1 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3'>
      ...
      <div 
        ...
        <div className="absolute  top-[50%] left-[50%] translate-x-[-50%] 
            ...
            {/* <h1 className='pt-2 pb-4 text-justify text-md md:text-lg lg:text-xl text-cyan-900 font-medium'>{item.info}</h1> */}
            <Link 
            href={item.route}
